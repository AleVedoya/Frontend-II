...
function crearCard(noticia, contenedor) {
  let card = document.createElement("article");
  let imagen = document.createElement("img");
  let noticiap = document.createElement("div");
  ...
  card.setAttribute("class", "articulo");
  imagen.setAttribute("src", noticia.imgUrl);
  imagen.setAttribute("alt", "imagen de la noticia");
  noticiap.setAttribute("class", "noticia");
  titulo.setAttribute("class", "news-title");
  descripcion.setAttribute("class", "description");
  fecha.setAttribute("class", "date");
  nacional.setAttribute("class", "nac");
  detalle.setAttribute("class", "details");

  titulo.innerText = `Título: ${noticia.titulo}`;
  descripcion.innerText = noticia.descripcion;
  fecha.innerText = noticia.fecha;

  if (noticia.tipoNacional) {
    nacional.innerText = "Noticia Nacional";
  } else {
    nacional.innerText = "Noticia Internacional";
  }

  card.append(imagen, noticiap);
  detalle.append(fecha, nacional);
  noticiap.append(titulo, descripcion, detalle);
